...
public class EsxCompositeSample extends EsxComposite {
	 ...
	 * @param style
	 */
	public EsxCompositeSample(EsxEditorPart parentPart,
		...
		textSelectedTotal = this.createGridData2ColumnTextLabel(
				groupSelectedSamples, "Total # Selected");
		textSelectedNotEmpty = this.createGridData2ColumnTextLabel(
				groupSelectedSamples, "# of Selected (Not Empty)");
		textSelectedEmpty = this.createGridData2ColumnTextLabel(
				groupSelectedSamples, "# of Selected (Empty)");
		...
		inputName = this.createGridData2ColumnTextInput(groupSampleName,
				"Name", new SelectionAdapter() {
					@Override
					public void widgetSelected(SelectionEvent e) {
						setFeatureForSelectedItems(samples,
								EsxPackage.Literals.SAMPLE__NAME,
								inputName.getText(), appendName.getSelection(),
								8);
					}
				});
		appendName = this.createGridData4ColumnCheckButton(groupSampleName,
				"Append # when multiple samples are selected", true);
		...
		textSampleRate = this.createGridData2ColumnTextLabel(groupGeneralInfo,
				"Sample Rate");
		textSampleTune = this.createGridData2ColumnTextLabel(groupGeneralInfo,
				"Sample Tune");
		textIsSlice = this.createGridData2ColumnTextLabel(groupGeneralInfo,
				"Is Slice?");
		textIsLoop = this.createGridData2ColumnTextLabel(groupGeneralInfo,
				"Is Loop?");
		...
		textNumberOfSampleFrames = this.createGridData2ColumnTextLabel(
				groupSizeInfo, "Length");
		textMemUsedInBytes = this.createGridData2ColumnTextLabel(groupSizeInfo,
				"Mem Used");
		textStart = this.createGridData2ColumnTextLabel(groupSizeInfo, "Start");
		inputStart = this.createGridData2ColumnTextInput(groupSizeInfo,
				"Start", new SelectionAdapter() {
					@Override
					public void widgetSelected(SelectionEvent e) {
						setFeatureForSelectedItems(samples,
								EsxPackage.Literals.SAMPLE__START,
								Integer.parseInt(inputStart.getText()), false,
								-1);
					}
				});
		textLoopStart = this.createGridData2ColumnTextLabel(groupSizeInfo,
				"Loop Start");
		inputLoopStart = this.createGridData2ColumnTextInput(groupSizeInfo,
				"Loop Start", new SelectionAdapter() {
					@Override
					public void widgetSelected(SelectionEvent e) {
						setFeatureForSelectedItems(samples,
								EsxPackage.Literals.SAMPLE__LOOP_START,
								Integer.parseInt(inputLoopStart.getText()),
								false, -1);
					}
				});
		textEnd = this.createGridData2ColumnTextLabel(groupSizeInfo, "End");
		inputEnd = this.createGridData2ColumnTextInput(groupSizeInfo, "End",
				new SelectionAdapter() {
					@Override
					public void widgetSelected(SelectionEvent e) {
						setFeatureForSelectedItems(samples,
								EsxPackage.Literals.SAMPLE__END,
								Integer.parseInt(inputEnd.getText()), false, -1);
					}
				});
		...
		textStretchStep = this.createGridData2ColumnTextLabel(groupMiscInfo,
				"Stretch Step");
		comboStretchStep = this.createGridData2ColumnComboInput(groupMiscInfo,
				"Stretch Step", this.getLiteralStrings(StretchStep.values()),
				new SelectionAdapter() {
					@Override
					public void widgetSelected(SelectionEvent e) {
						setFeatureForSelectedItems(samples,
								EsxPackage.Literals.SAMPLE__STRETCH_STEP,
								StretchStep.get(comboStretchStep
										.getSelectionIndex() - 1), false, -1);
					}
				});
		textPlayLevel = this.createGridData2ColumnTextLabel(groupMiscInfo,
				"Play Level");
		comboPlayLevel = this.createGridData2ColumnComboInput(groupMiscInfo,
				"Play Level", this.getLiteralStrings(PlayLevel.values()),
				new SelectionAdapter() {
					@Override
					public void widgetSelected(SelectionEvent e) {
						setFeatureForSelectedItems(samples,
								EsxPackage.Literals.SAMPLE__PLAY_LEVEL,
								PlayLevel.get(comboPlayLevel
	...
	@Override
	public void refresh() {
		if (this.isActive == false || this.samples == null)
			return;
		...
		this.textSelectedNotEmpty.setText(Integer.toString(this
				.getCountInListWithValue(this.samples,
						EsxPackage.Literals.SAMPLE__EMPTY, false)));
		this.textSelectedEmpty.setText(Integer.toString(this
				.getCountInListWithValue(this.samples,
						EsxPackage.Literals.SAMPLE__EMPTY, true)));

		this.textName.setText(getMultiString(this.samples,
				EsxPackage.Literals.SAMPLE__NAME, multipleValueString));

		this.textSampleRate.setText(getMultiString(this.samples,
				EsxPackage.Literals.SAMPLE__SAMPLE_RATE, multipleValueString));
		this.textSampleTune.setText(getMultiString(this.samples,
				EsxPackage.Literals.SAMPLE__SAMPLE_TUNE, multipleValueString,
		...
		this.textMemUsedInBytes.setText(getMultiString(this.samples,
				...
				multipleValueString));
		this.textNumberOfSampleFrames.setText(getMultiString(this.samples,
				EsxPackage.Literals.SAMPLE__NUMBER_OF_SAMPLE_FRAMES,
				multipleValueString));
		this.textStart.setText(getMultiString(this.samples,
				EsxPackage.Literals.SAMPLE__START, multipleValueString));
		this.textEnd.setText(getMultiString(this.samples,
				EsxPackage.Literals.SAMPLE__END, multipleValueString));
		this.textLoopStart.setText(getMultiString(this.samples,
				EsxPackage.Literals.SAMPLE__LOOP_START, multipleValueString));

		this.textStretchStep.setText(getMultiString(this.samples,
				EsxPackage.Literals.SAMPLE__STRETCH_STEP, multipleValueString));
		this.textPlayLevel.setText(getMultiString(this.samples,
				EsxPackage.Literals.SAMPLE__PLAY_LEVEL, multipleValueString));
	}
	...
	public void refreshInputs() {
		...
		this.inputName.setText(getMultiString(this.samples,
				EsxPackage.Literals.SAMPLE__NAME, multipleValueString));

		this.inputStart.setText(getMultiString(this.samples,
				EsxPackage.Literals.SAMPLE__START, multipleValueString));
		this.inputEnd.setText(getMultiString(this.samples,
				EsxPackage.Literals.SAMPLE__END, multipleValueString));
		this.inputLoopStart.setText(getMultiString(this.samples,
				EsxPackage.Literals.SAMPLE__LOOP_START, multipleValueString));

		this.comboStretchStep.setText(getMultiString(this.samples,
				EsxPackage.Literals.SAMPLE__STRETCH_STEP, multipleValueString));
		this.comboPlayLevel.setText(getMultiString(this.samples,
				EsxPackage.Literals.SAMPLE__PLAY_LEVEL, multipleValueString));
	}
