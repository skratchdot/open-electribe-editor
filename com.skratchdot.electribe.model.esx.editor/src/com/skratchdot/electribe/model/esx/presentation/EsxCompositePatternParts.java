...
public class EsxCompositePatternParts extends EsxComposite {
	 ...
	 * @param style
	 */
	public EsxCompositePatternParts(EsxEditorPart parentPart,
	...
	private void initTableViewer() {
		...
		// Create our columns
		this.parentPart.addColumnToTableViewer(this.tableViewer, "Part Label",
				null);
		...
		this.parentPart.addColumnToTableViewer(this.tableViewer,
				"Sample Label", null);
		this.parentPart.addColumnToTableViewer(this.tableViewer, "Pitch/Glide",
				null);
		this.parentPart.addColumnToTableViewer(this.tableViewer, "Pan", null);
		this.parentPart.addColumnToTableViewer(this.tableViewer, "Eg Time",
				null);
		this.parentPart.addColumnToTableViewer(this.tableViewer, "Start Point",
				null);
		this.parentPart
				.addColumnToTableViewer(this.tableViewer, "Amp Eg", null);
		this.parentPart.addColumnToTableViewer(this.tableViewer, "Roll", null);
		this.parentPart.addColumnToTableViewer(this.tableViewer, "Reverse",
				null);
		this.parentPart.addColumnToTableViewer(this.tableViewer, "FX Select",
				null);
		this.parentPart.addColumnToTableViewer(this.tableViewer, "FX Send",
				null);
		this.parentPart.addColumnToTableViewer(this.tableViewer, "Mod Type",
				null);
		this.parentPart.addColumnToTableViewer(this.tableViewer, "Mod Dest",
				null);
		this.parentPart.addColumnToTableViewer(this.tableViewer, "Mod Speed",
				null);
		this.parentPart.addColumnToTableViewer(this.tableViewer, "Mod Depth",
				null);
		this.parentPart.addColumnToTableViewer(this.tableViewer, "BPM Sync",
				null);
		this.parentPart
				.addColumnToTableViewer(this.tableViewer, "Cutoff", null);
		this.parentPart.addColumnToTableViewer(this.tableViewer, "Resonance",
				null);
		this.parentPart.addColumnToTableViewer(this.tableViewer,
				"Eg Intensity", null);
		this.parentPart.addColumnToTableViewer(this.tableViewer, "Filter Type",
				null);
			...
			if (((List<?>) input).size() > 1) {
				...
				while (it.hasNext() && isIterating == true) {
					...
					if (obj instanceof Pattern) {
						...
						this.selectedPatternParts.addAll(this.selectedPattern
								.getDrumParts());
						this.selectedPatternParts.addAll(this.selectedPattern
								.getKeyboardParts());
						this.selectedPatternParts.addAll(this.selectedPattern
								.getStretchSliceParts());
						this.selectedPatternParts.add(this.selectedPattern
								.getAudioInPart());
						this.selectedPatternParts.add(this.selectedPattern
								.getAccentPart());
						this.selectedPart = null;
