 ...
 * <!-- end-user-doc -->
 * @see com.skratchdot.electribe.model.esx.EsxPackage#getBpmSync()
 * @model
 * @generated
 */
public enum BpmSync implements Enumerator {
	 ...
	 * @generated
	 */
	private static final BpmSync[] VALUES_ARRAY =
		new BpmSync[] {
			OFF,
			ON,
		};
	 ...
	 * @generated
	 */
	public static final List<BpmSync> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
