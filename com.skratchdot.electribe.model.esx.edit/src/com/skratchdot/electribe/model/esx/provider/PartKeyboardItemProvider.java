 ...
 * @generated
 */
public class PartKeyboardItemProvider extends PartItemProvider implements
	...
	protected void addGlidePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_PartKeyboard_glide_feature",
						"_UI_PartKeyboard_type"),
				EsxPackage.Literals.PART_KEYBOARD__GLIDE, true, false, false,
				ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(EsxPackage.Literals.PART_KEYBOARD__SEQUENCE_DATA_NOTE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/PartKeyboard"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_PartKeyboard_type")
