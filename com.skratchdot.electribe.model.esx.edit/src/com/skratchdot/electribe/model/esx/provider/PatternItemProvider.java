 ...
 * @generated
 */
public class PatternItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Pattern_name_feature", "_UI_Pattern_type"),
				EsxPackage.Literals.PATTERN__NAME, true, false, false,
	...
	protected void addLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Pattern_label_feature", "_UI_Pattern_type"),
				EsxPackage.Literals.PATTERN__LABEL, false, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTempoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Pattern_tempo_feature", "_UI_Pattern_type"),
				EsxPackage.Literals.PATTERN__TEMPO, false, false, false, null,
				null, null));
	}
	...
	protected void addSwingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Pattern_swing_feature", "_UI_Pattern_type"),
				EsxPackage.Literals.PATTERN__SWING, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addPatternLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_Pattern_patternLength_feature",
								"_UI_Pattern_type"),
						EsxPackage.Literals.PATTERN__PATTERN_LENGTH, true,
						false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addBeatPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Pattern_beat_feature", "_UI_Pattern_type"),
				EsxPackage.Literals.PATTERN__BEAT, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addRollTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Pattern_rollType_feature", "_UI_Pattern_type"),
				EsxPackage.Literals.PATTERN__ROLL_TYPE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addFxChainPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Pattern_fxChain_feature", "_UI_Pattern_type"),
				EsxPackage.Literals.PATTERN__FX_CHAIN, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addLastStepPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Pattern_lastStep_feature", "_UI_Pattern_type"),
				EsxPackage.Literals.PATTERN__LAST_STEP, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addArpeggiatorScalePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Pattern_arpeggiatorScale_feature",
						"_UI_Pattern_type"),
				EsxPackage.Literals.PATTERN__ARPEGGIATOR_SCALE, true, false,
	...
	protected void addArpeggiatorCenterNotePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Pattern_arpeggiatorCenterNote_feature",
						"_UI_Pattern_type"),
				EsxPackage.Literals.PATTERN__ARPEGGIATOR_CENTER_NOTE, true,
	...
	protected void addEmptyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Pattern_empty_feature", "_UI_Pattern_type"),
				EsxPackage.Literals.PATTERN__EMPTY, false, false, false,
	...
	protected void addPatternNumberOriginalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Pattern_patternNumberOriginal_feature",
						"_UI_Pattern_type"),
				EsxPackage.Literals.PATTERN__PATTERN_NUMBER_ORIGINAL, false,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addPatternNumberCurrentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Pattern_patternNumberCurrent_feature",
						"_UI_Pattern_type"),
				EsxPackage.Literals.PATTERN__PATTERN_NUMBER_CURRENT, false,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(EsxPackage.Literals.PATTERN__STRETCH_SLICE_PARTS);
			...
			childrenFeatures
					.add(EsxPackage.Literals.PATTERN__MOTION_PARAMETERS);
		}
	...
	public String getColumnText(Object object, int columnIndex) {
		...
		case 11:
			...
			// Fx1 Type
		case 12:
			return ((Pattern) object).getFxParameters().get(0).getEffectType()
					.getLiteral();
			// Fx2 Type
		case 13:
			return ((Pattern) object).getFxParameters().get(1).getEffectType()
					.getLiteral();
			// Fx3 Type
		case 14:
			return ((Pattern) object).getFxParameters().get(2).getEffectType()
					.getLiteral();
			// Part 1
		case 15:
		...
		case 23:
			...
			// Key 1
		case 24:
			return ((Pattern) object).getKeyboardParts().get(0)
					.getSampleLabel();
			// Key 2
		case 25:
			return ((Pattern) object).getKeyboardParts().get(1)
					.getSampleLabel();
			// Stretch 1
		case 26:
			return ((Pattern) object).getStretchSliceParts().get(0)
					.getSampleLabel();
			// Stretch 2
		case 27:
			return ((Pattern) object).getStretchSliceParts().get(1)
					.getSampleLabel();
			// Slice
		case 28:
			return ((Pattern) object).getStretchSliceParts().get(2)
					.getSampleLabel();
		default:
