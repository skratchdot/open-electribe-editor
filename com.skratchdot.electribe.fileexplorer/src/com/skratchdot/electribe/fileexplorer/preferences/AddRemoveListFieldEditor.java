...
public class AddRemoveListFieldEditor extends FieldEditor {
	...
	public AddRemoveListFieldEditor(String name, String labelText,
			Composite parent) {
	...
	protected void doFillIntoGrid(Composite parent, int numColumns) {
		...
		listData.heightHint = convertVerticalDLUsToPixels(list,
				LIST_HEIGHT_IN_DLUS);
		...
		addData.widthHint = convertHorizontalDLUsToPixels(add,
		...
		removeData.widthHint = convertHorizontalDLUsToPixels(remove,
				IDialogConstants.BUTTON_WIDTH);
