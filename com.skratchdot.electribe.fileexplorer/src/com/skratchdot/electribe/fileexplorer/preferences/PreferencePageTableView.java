...
public class PreferencePageTableView extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public void init(IWorkbench workbench) {
		...
		setDescription(
			"You can make Table View preference settings below." +
