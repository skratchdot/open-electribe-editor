...
public class EsxEditor
	 ...
	 * @generated
	 */
	public static final List<String> FILE_EXTENSION_FILTERS = prefixExtensions(Arrays.asList(EsxEditorPlugin.INSTANCE.getString("_UI_EsxEditorFilenameExtensions").split("\\s*,\\s*")), "*.");
		...
		if (!getEditingDomain().getResourceSet().getResources().isEmpty()) {
			...
			//
			{
				ViewerPane viewerPane =
					new ViewerPane(getSite().getPage(), EsxEditor.this) {
						@Override
