...
public class EsxPreferencePageSamples extends FieldEditorPreferencePage
	...
	protected void createFieldEditors() {
		...
		addField(new ColorFieldEditor(EsxPreferenceNames.SAMPLES_BACKGROUND_COLOR_WHEN_NOT_EMPTY, "Background Color When Not Empty", getFieldEditorParent()));
		addField(new ColorFieldEditor(EsxPreferenceNames.SAMPLES_FOREGROUND_COLOR_WHEN_NOT_EMPTY, "Foreground Color When Not Empty", getFieldEditorParent()));
		addField(new ColorFieldEditor(EsxPreferenceNames.SAMPLES_BACKGROUND_COLOR_WHEN_EMPTY, "Background Color When Empty", getFieldEditorParent()));
		addField(new ColorFieldEditor(EsxPreferenceNames.SAMPLES_FOREGROUND_COLOR_WHEN_EMPTY, "Foreground Color When Empty", getFieldEditorParent()));
	}
