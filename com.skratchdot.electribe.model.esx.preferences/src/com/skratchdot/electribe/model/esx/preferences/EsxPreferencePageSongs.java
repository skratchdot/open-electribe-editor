...
public class EsxPreferencePageSongs extends FieldEditorPreferencePage implements
	...
	public void init(IWorkbench workbench) {
		...
		setDescription("You can change the Song preference settings below."
	...
	protected void createFieldEditors() {
		...
		addField(new BooleanFieldEditor(
				EsxPreferenceNames.SONGS_USE_SCROLL_SPEED, "Use Scroll Speed",
